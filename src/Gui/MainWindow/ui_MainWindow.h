...
public:
    ...
    QAction *m_aboutMonopolyMoneyAction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/monopolymoney"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutMonopolyMoneyAction = new QAction(MainWindow);
        m_aboutMonopolyMoneyAction->setObjectName(QStringLiteral("m_aboutMonopolyMoneyAction"));
        m_aboutMonopolyMoneyAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutMonopolyMoneyAction);
        ...
        QObject::connect(m_aboutMonopolyMoneyAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutMonopolyMoneyAction->setText(QApplication::translate("MainWindow", "About MonopolyMoney", 0));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND MONOPOLYMONEY", 0));
