...
const char COMMUNITY_FORUM_URL[] = "https://monopolymoneytalk.org";
const char REPORT_ISSUE_URL[] = "https://mymn.io/contact";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("MonopolyMoney Wallet %1").arg(Settings::instance().getVersion()));
